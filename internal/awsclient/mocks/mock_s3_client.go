...
// Source: go-tf-provisioner/internal/awsclient (interfaces: S3Client)
//
// Generated by this command:
//
//	mockgen -destination=mocks/mock_s3_client.go -package=mocks go-tf-provisioner/internal/awsclient S3Client
//
