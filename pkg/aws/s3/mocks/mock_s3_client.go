...
// Source: go-tf-provisioner/pkg/aws/s3 (interfaces: Client)
//
// Generated by this command:
//
//	mockgen -destination=mocks/mock_s3_client.go -package=mocks go-tf-provisioner/pkg/aws/s3 Client
//
...
func (mr *MockClientMockRecorder) HeadObject(ctx, params any, optFns ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, params}, optFns...)
...
func (mr *MockClientMockRecorder) ListObjectsV2(ctx, params any, optFns ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, params}, optFns...)
